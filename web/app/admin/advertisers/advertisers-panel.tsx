...
import {
  adminGetAdvertiser,
  adminGetAdvertiserCountryBreakdown,
  adminListAdvertisers,
  ApiError,
} from "@/lib/api"
import type {
  AdminAdvertiserCountryRow,
...
function AdvertiserCountryReport() {
  const [rows, setRows] = React.useState<AdminAdvertiserCountryRow[] | null>(
    null
  )
    ...
    <Card>
      <CardContent className="space-y-3 py-5">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold">Advertisers by country</h3>
        </div>
        {loading ? (
