      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-violet-50 via-violet-50/40 to-background">
        ...
        <div className="mx-auto grid max-w-6xl xl:max-w-7xl 2xl:max-w-[1600px] items-center gap-10 px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:grid-cols-2">
          <div className="lg:col-span-2">
            <Breadcrumbs
              items={[
                ...
                { name: "Social Bar Ads", path: "/ad-formats/social-bar" },
              ]}
            />
          </div>
          <div>
          ...
          <div className="relative mx-auto w-full max-w-sm">
            <div className="rotate-2 rounded-xl border border-neutral-800 bg-neutral-900 p-2 shadow-2xl shadow-violet-900/10">
              <div className="overflow-hidden rounded-lg bg-card">
                <div className="h-24 bg-violet-100" />
                <div className="space-y-2 p-3">
                  <div className="h-2.5 w-2/3 rounded bg-muted" />
                  <div className="flex items-center gap-2 rounded-md border p-2">
                    <div className="flex size-7 shrink-0 items-center justify-center rounded-full bg-violet-500/10 text-violet-600">
