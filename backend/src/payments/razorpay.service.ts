...
// Thin wrapper around the Razorpay SDK/HMAC verification. Nothing here
// touches the wallet or the ledger - PaymentsService owns that, this is
// purely "talk to Razorpay correctly and safely".
@Injectable()
export class RazorpayService {
  ...
  // refusing to start. Live keys can be dropped into the environment later
  // with no code change and no restart-order dependency.
